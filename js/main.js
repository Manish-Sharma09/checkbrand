...
$(document).ready(function(){
  $(".compare-input").focusin(function(){
    $(".compareContentArea").css("display", "none");
  });
  
   $(".compare-input").keypress(function(){
    $(".compare-input").css("background", "#f0f0f2");
  });
  
  
  $(".compare-input").focusout(function(){
    if ( $(this).val().length > 0 ){
     $(this).parent(".compareInputPanel").find('.compareContentArea').css("display", "none")
     //$(".compareContentArea").css("display", "none");
  }else{
     //$(".compareContentArea").css("display", "block");
     $(this).parent(".compareInputPanel").find('.compareContentArea').css("display", "block")
